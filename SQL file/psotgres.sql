...
--
-- Ho... SQLINES DEMO ***
-- SQLINES DEMO *** Jan 22, 2022 at 07:58 PM
...
CREATE TABLE admin (
  ...
  updationDate timestamp(0) NOT NULL DEFAULT '0000-00-00 00:00:00' /* ON UPDATE current_timestamp() */
) ;
...
--
-- SQLINES DEMO *** or table `tblauthors`
--
...
--
-- SQLINES DEMO *** or table `tblbooks`
--
...
(11, 'SID012', 'John Doe', 'john@test.com', '1234569870', 'f925916e2754e5e03f75dd58a5733251', 1, '2022-01-22 08:16:18'