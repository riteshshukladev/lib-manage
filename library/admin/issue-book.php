...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['issue'])) {
        ...
        // First, insert the issue record
        $sql1 = "INSERT INTO tblissuedbookdetails(studentid, bookid) VALUES(:studentid, :bookid)";
        ...
        // If the insert was successful, update the book record
        if ($lastInsertId) {
            $sql2 = "UPDATE tblbooks SET isissued = :isissued WHERE id = :bookid";
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- Fixed typo in the input name from 'booikid' to 'bookid' -->
